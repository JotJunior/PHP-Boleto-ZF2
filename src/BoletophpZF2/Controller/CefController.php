 ...
 * 
 * Originado do Projeto PhpBoletoFree que tiveram colaborações de Daniel
...
class CefController extends AbstractActionController {
	...
	public function indexAction() {
		...
		$service = $this->getServiceLocator()->get('BoletophpZF2\Service\Cef');
		...
		switch ($this->params()->fromRoute('format')) {
			...
			case 'pdf' :
				$pdf = new PdfModel();
				$pdf->setOption('filename', 'boleto-cef');
